...
이 폴더는 사전학습된 **DINOv2 (ViT-g/14)** 를 그대로 가져와서, 논문이 제기한
...
**Norm map** — ViT-g/14는 배경 등 일부 패치에서 norm이 폭발하는 artifact가 또렷하게 보입니다(밝은 점).

![g14 norm map](results/norm_map_dinov2_vitg14.png)
